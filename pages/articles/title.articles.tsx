...
export default function TitleArticles() {
  return (
    <Head>
      ...
      />
      <title>Articles by Joseph Damiba</title>
      <meta
        name="description"
        content="Explore articles authored by Joseph Damiba, a Full Stack Engineer and Developer."
      />
