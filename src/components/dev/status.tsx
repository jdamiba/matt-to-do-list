          ...
          {hideContent ? null : (
            <>
              ...
              <p style={{ fontSize: "14px", marginBottom: "30px" }}>
                ...
                <a href="https://github.com/jdamiba/portfolio/issues/new">
                  @muhammad-fiaz
                </a>
              </p>
              {!isVerified ? (
                ...
                <span
                  dangerouslySetInnerHTML={{
                    __html: WelMsg.replace(
                      "Github",
                      '<a href="https://github.com/muhammad-fiaz" target="_blank" rel="noopener noreferrer" style="color: #3498db;">Github</a>'
                    ),
                  }}
                />
              </h2>
        ...
        {autoupdatecheck && (
          ...
          >
            <p>
              ...
              {versionDetails ? (
                <a
                  href={`https://github.com/jdamiba/portfolio/releases/tag/v${versionDetails.currentVersion}`}
                  target="_blank"
